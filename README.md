...
Actions. It performs a feature, like - Add, remove, toggle. It contain properties related to some action that happens inside App.`

Reducers. Its Kind of like packaging like items together. Takes 2 
arguments - current state and action and returns new updated sate object base on both arguments

Store. Kind of like a store- contains everything. A Single Javascript object. contains our state for our entire application
